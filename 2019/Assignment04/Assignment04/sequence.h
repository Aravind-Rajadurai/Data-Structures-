...
namespace CS3358_SP2019_A04_
{
    template <class Temp> class sequence
    {
    public:
        // TYPEDEFS and MEMBER CONSTANTS
        typedef Temp value_type;
        ...
        void advance();
        void move_back();
        void add(const Temp& entry);
        void remove_current();
        // CONSTANT MEMBER FUNCTIONS size_type size() const;
        bool is_item() const;
        Temp current() const;
        size_type size() const;
    private:
        Temp data[CAPACITY]; size_type used; size_type current_index;
    };
    
}
#include "sequence.template" // Compiler inclusion #endif
